  ...
  const contactInfo = [
    {
      icon: FaEnvelope,
      title: "EMAIL",
      value: "jhoncarlosacevedomendoza@",
      link: "mailto:jhoncarlosacevedomendoza@gmail.com"
    },
    {
      icon: FaLinkedin,
      title: "LINKEDIN",
      value: "linkedin.com/in/jhon-carlos-acevedo-mendoza",
      link: "https://linkedin.com/in/jhon-carlos-acevedo-mendoza"
    },
    {
      icon: FaGithub,
      title: "GITHUB",
      value: "github.com/jhoncarlosam-dev",
      link: "https://github.com/jhoncarlosam-dev"
    }
  ];
